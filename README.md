> **Deprecated:** This CDK-based project has been deprecated. Deployment has moved to Terraform. Please refer to [langgenius/dify-ee-terraform-aws](https://github.com/langgenius/dify-ee-terraform-aws).
